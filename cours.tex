...
\end{equation}
Cela signifie que si nous doublons le volume d'un gaz, sa pression sera divisée par deux. La loi de Boyle peut se représenter graphiquement comme sur la figure~%TODO
...
une pression $P_1$ et qu'il y a un autre état d'équilibre avec volume $V_2$ et pression $P_2$ toujours à tempàrature $T_0$ alors l'équation suivante est vérifiée
\begin{equation}
P_1V_1=P_2V_2.
\end{equation}
\end{document}
