...
La vision de la chaleur comme la quantité d'énergie
transférée entre deux objets ayant des températures différentes,
allant de l'objet chaud vers l'objet froid. 
...
W=F_\parallel d.
\end{equation}
L'unité du travail est le joule (noté $\mathrm{J}=\mathrm{N}\cdot\m$). La notion d'énergie est basée sur le concept de travail. 
On peut en fait la définir comme la capacité à effectuer un travail. Il existe beaucoup de différents types d'énergie (potentielle, électrique, cinétique, ...). 
...
\begin{equation}
E_\mathrm{bolt}=\frac{1}{2}\cdot 94\cdot 14.2^2=7.23\mathrm{kJ}=1.73\mathrm{kcal}.
\end{equation}
Son énergie cinétique à ce moment là aurait permis de chauffer
une tonne d'eau de $1.73^\circ\C$. Ce même Usain Bolt en train 
...
est transformé en énergie thermique en chauffant l'eau.



\subsection{Chaleur et énergie}
